...
// Poster Boards
  async function createPoster(name, butPosition, posterImage = null, posterLink, localRotation = new BS.Vector3(0,0,0), localScale = new BS.Vector3(1, 1, 1), width = 1.2, height = 1.8) {
    ...
    createPoster('PosterL1', new BS.Vector3(-13.27,3.2,-12.05), 'https://firer.at/files/VolumeMute.png', 'https://comcotheatre.com/packages/', new BS.Vector3(0,-45.55,0));
